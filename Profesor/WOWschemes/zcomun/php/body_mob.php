<body class='estimgFondopc'>
    <div>
        <a id="logo" target="_top"  href="http://wowschemes.com"><img border="0" width="160" height="45" src="/zimgs/logo.gif" /></a>
    </div>
    <div class="rounded-cabecera" style="width:360px;height:80px;margin:0 auto;">
    ...
    <!-- Ejemplo de Hechizo con Tooltip a borrar -->
    <br>
